...
<!-- LOC_START -->
**1,019,929** lines of code across **1,250,382** total lines

| Language | Lines of Code | % |
|----------|-------------:|--:|
| Java | 273,328 | 26.8% |
| TypeScript | 178,015 | 17.5% |
| JSON | 124,631 | 12.2% |
| Go | 124,234 | 12.2% |
| HTML | 74,636 | 7.3% |
| Markdown | 71,259 | 7.0% |
...
------------------------------------------------------------
raizhost.com                   up         200    203ms       
app.raizhost.com               up         307    164ms       
jadenrazo.dev                  up         200    117ms       
llm.raizhost.com               up         200    120ms       
showersautodetail.com          up         200    139ms       
------------------------------------------------------------
fleet average                                    148ms       

Last check: 2026-08-07T05:45:57Z (3 probes per site, averaged)
```
<!-- DEPLOY_MONITOR_END -->
