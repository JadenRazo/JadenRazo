...
<!-- LOC_START -->
**633,824** lines of code across **776,738** total lines

| Language | Lines of Code | % |
|----------|-------------:|--:|
| Java | 169,576 | 26.8% |
| TypeScript | 138,391 | 21.8% |
| JSON | 89,492 | 14.1% |
| Go | 79,112 | 12.5% |
| YAML | 32,448 | 5.1% |
| Markdown | 31,728 | 5.0% |
...
claude.raizhost.com            up         200    400ms     
showersautodetail.com          up         200    37ms      

Last check: 2026-05-09T17:30:01Z
```
<!-- DEPLOY_MONITOR_END -->
