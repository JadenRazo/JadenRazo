...
<!-- LOC_START -->
**1,028,893** lines of code across **1,263,002** total lines

| Language | Lines of Code | % |
|----------|-------------:|--:|
| Java | 278,127 | 27.0% |
| TypeScript | 180,594 | 17.6% |
| JSON | 125,300 | 12.2% |
| Go | 124,234 | 12.1% |
| HTML | 74,740 | 7.3% |
| Markdown | 71,409 | 6.9% |
...
------------------------------------------------------------
raizhost.com                   up         200    210ms       
app.raizhost.com               up         307    151ms       
jadenrazo.dev                  up         200    133ms       
llm.raizhost.com               up         200    119ms       
showersautodetail.com          up         200    180ms       
------------------------------------------------------------
fleet average                                    158ms       

Last check: 2026-08-08T08:51:00Z (3 probes per site, averaged)
```
<!-- DEPLOY_MONITOR_END -->
