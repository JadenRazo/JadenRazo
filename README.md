...
<!-- LOC_START -->
**1,039,291** lines of code across **1,275,559** total lines

| Language | Lines of Code | % |
|----------|-------------:|--:|
| Java | 278,127 | 26.8% |
| TypeScript | 184,843 | 17.8% |
| JSON | 125,808 | 12.1% |
| Go | 124,234 | 12.0% |
| HTML | 75,112 | 7.2% |
| Markdown | 72,193 | 6.9% |
...
jadenrazo.dev                  up         200    111ms       
llm.raizhost.com               up         200    114ms       
showersautodetail.com          up         200    169ms       
------------------------------------------------------------
fleet average                                    139ms       

Last check: 2026-08-19T07:49:04Z (3 probes per site, averaged)
```
<!-- DEPLOY_MONITOR_END -->
