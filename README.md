...
<!-- LOC_START -->
**640,062** lines of code across **784,856** total lines

| Language | Lines of Code | % |
|----------|-------------:|--:|
| Java | 169,576 | 26.5% |
| TypeScript | 138,804 | 21.7% |
| JSON | 89,033 | 13.9% |
| Go | 79,112 | 12.4% |
| Markdown | 32,540 | 5.1% |
| YAML | 32,526 | 5.1% |
...
claude.raizhost.com            up         200    525ms     
showersautodetail.com          up         200    53ms      

Last check: 2026-05-12T16:00:01Z
```
<!-- DEPLOY_MONITOR_END -->
