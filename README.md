...
<!-- LOC_START -->
**781,776** lines of code across **959,557** total lines

| Language | Lines of Code | % |
|----------|-------------:|--:|
| Java | 169,576 | 21.7% |
| TypeScript | 165,103 | 21.1% |
| Go | 123,835 | 15.8% |
| JSON | 116,573 | 14.9% |
| Markdown | 41,886 | 5.4% |
| YAML | 37,136 | 4.8% |
...
app.raizhost.com               up         307    6603ms    
jadenrazo.dev                  up         200    109ms     
claude.raizhost.com            up         301    28ms      
showersautodetail.com          up         200    21ms      

Last check: 2026-06-09T12:30:01Z
```
<!-- DEPLOY_MONITOR_END -->
