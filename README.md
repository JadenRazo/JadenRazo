...
<!-- LOC_START -->
**785,926** lines of code across **964,093** total lines

| Language | Lines of Code | % |
|----------|-------------:|--:|
| Java | 169,576 | 21.6% |
| TypeScript | 165,103 | 21.0% |
| Go | 123,835 | 15.8% |
| JSON | 116,573 | 14.8% |
| Markdown | 41,926 | 5.3% |
| YAML | 37,201 | 4.7% |
...
----------------------------------------------------------
raizhost.com                   up         200    294ms     
app.raizhost.com               up         307    1934ms    
jadenrazo.dev                  up         200    117ms     
claude.raizhost.com            up         301    29ms      
showersautodetail.com          up         200    31ms      

Last check: 2026-06-11T07:00:01Z
```
<!-- DEPLOY_MONITOR_END -->
