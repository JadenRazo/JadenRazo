...
<!-- LOC_START -->
**1,141,787** lines of code across **1,381,799** total lines

| Language | Lines of Code | % |
|----------|-------------:|--:|
| Java | 278,128 | 24.4% |
| TypeScript | 195,513 | 17.1% |
| JSON | 190,151 | 16.7% |
| Go | 124,234 | 10.9% |
| HTML | 84,564 | 7.4% |
| Markdown | 76,060 | 6.7% |
...
app.raizhost.com               up         307    188ms       
jadenrazo.dev                  up         200    104ms       
llm.raizhost.com               up         200    472ms       
showersautodetail.com          up         200    168ms       
------------------------------------------------------------
fleet average                                    221ms       

Last check: 2026-08-29T01:54:08Z (3 probes per site, averaged)
```
<!-- DEPLOY_MONITOR_END -->
