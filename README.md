...
<!-- LOC_START -->
**609,602** lines of code across **747,509** total lines

| Language | Lines of Code | % |
|----------|-------------:|--:|
| Java | 169,576 | 27.8% |
| TypeScript | 138,391 | 22.7% |
| JSON | 86,515 | 14.2% |
| Go | 69,458 | 11.4% |
| YAML | 31,262 | 5.1% |
| Markdown | 29,704 | 4.9% |
...
claude.raizhost.com            up         200    596ms     
showersautodetail.com          up         200    46ms      

Last check: 2026-05-01T18:00:01Z
```
<!-- DEPLOY_MONITOR_END -->
