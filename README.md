...
<!-- LOC_START -->
**781,234** lines of code across **959,520** total lines

| Language | Lines of Code | % |
|----------|-------------:|--:|
| Java | 169,057 | 21.6% |
| TypeScript | 165,094 | 21.1% |
| Go | 123,835 | 15.9% |
| JSON | 116,598 | 14.9% |
| Markdown | 41,850 | 5.4% |
| YAML | 37,133 | 4.8% |
...
----------------------------------------------------------
raizhost.com                   up         200    136ms     
app.raizhost.com               up         307    30ms      
jadenrazo.dev                  up         200    126ms     
claude.raizhost.com            up         301    43ms      
showersautodetail.com          degraded   404    40ms      

Last check: 2026-06-05T16:30:01Z
```
<!-- DEPLOY_MONITOR_END -->
