...
<!-- LOC_START -->
**810,855** lines of code across **994,053** total lines

| Language | Lines of Code | % |
|----------|-------------:|--:|
| Java | 169,576 | 20.9% |
| TypeScript | 165,103 | 20.4% |
| Go | 123,835 | 15.3% |
| JSON | 116,594 | 14.4% |
| Markdown | 43,101 | 5.3% |
| HTML | 41,860 | 5.2% |
...
----------------------------------------------------------
raizhost.com                   up         200    128ms     
app.raizhost.com               up         307    320ms     
jadenrazo.dev                  up         200    25ms      
claude.raizhost.com            up         301    30ms      
showersautodetail.com          up         200    134ms     

Last check: 2026-06-15T14:00:01Z
```
<!-- DEPLOY_MONITOR_END -->
