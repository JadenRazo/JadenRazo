...
<!-- LOC_START -->
**812,021** lines of code across **995,323** total lines

| Language | Lines of Code | % |
|----------|-------------:|--:|
| Java | 169,576 | 20.9% |
| TypeScript | 165,103 | 20.3% |
| Go | 123,835 | 15.3% |
| JSON | 116,594 | 14.4% |
| Markdown | 43,101 | 5.3% |
| HTML | 43,026 | 5.3% |
...
app.raizhost.com               up         307    277ms     
jadenrazo.dev                  up         200    19ms      
claude.raizhost.com            up         301    28ms      
showersautodetail.com          up         200    123ms     

Last check: 2026-06-25T00:30:01Z
```
<!-- DEPLOY_MONITOR_END -->
