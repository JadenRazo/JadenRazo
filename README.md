...
<!-- LOC_START -->
**1,138,813** lines of code across **1,378,518** total lines

| Language | Lines of Code | % |
|----------|-------------:|--:|
| Java | 278,128 | 24.4% |
| TypeScript | 193,638 | 17.0% |
| JSON | 189,488 | 16.6% |
| Go | 124,234 | 10.9% |
| HTML | 84,531 | 7.4% |
| Markdown | 75,795 | 6.7% |
...
------------------------------------------------------------
raizhost.com                   up         200    188ms       
app.raizhost.com               up         307    182ms       
jadenrazo.dev                  up         200    144ms       
llm.raizhost.com               up         200    305ms       
showersautodetail.com          up         200    177ms       
------------------------------------------------------------
fleet average                                    199ms       

Last check: 2026-08-27T21:07:16Z (3 probes per site, averaged)
```
<!-- DEPLOY_MONITOR_END -->
