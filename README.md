...
<!-- LOC_START -->
**628,706** lines of code across **770,333** total lines

| Language | Lines of Code | % |
|----------|-------------:|--:|
| Java | 169,576 | 27.0% |
| TypeScript | 138,391 | 22.0% |
| JSON | 89,468 | 14.2% |
| Go | 79,112 | 12.6% |
| YAML | 32,002 | 5.1% |
| Markdown | 31,265 | 5.0% |
...
jadenrazo.dev                  down       502    41ms      
claude.raizhost.com            up         200    96ms      
showersautodetail.com          up         200    42ms      

Last check: 2026-05-07T17:30:01Z
```
<!-- DEPLOY_MONITOR_END -->
