...
<!-- LOC_START -->
**1,041,110** lines of code across **1,278,206** total lines

| Language | Lines of Code | % |
|----------|-------------:|--:|
| Java | 278,127 | 26.7% |
| TypeScript | 185,975 | 17.9% |
| JSON | 125,954 | 12.1% |
| Go | 124,234 | 11.9% |
| HTML | 75,136 | 7.2% |
| Markdown | 72,414 | 7.0% |
...
------------------------------------------------------------
raizhost.com                   up         200    182ms       
app.raizhost.com               up         307    183ms       
jadenrazo.dev                  up         200    100ms       
llm.raizhost.com               up         200    474ms       
showersautodetail.com          up         200    154ms       
------------------------------------------------------------
fleet average                                    218ms       

Last check: 2026-08-20T08:07:07Z (3 probes per site, averaged)
```
<!-- DEPLOY_MONITOR_END -->
