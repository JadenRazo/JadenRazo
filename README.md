...
<!-- LOC_START -->
**1,132,396** lines of code across **1,371,699** total lines

| Language | Lines of Code | % |
|----------|-------------:|--:|
| Java | 278,128 | 24.6% |
| TypeScript | 193,215 | 17.1% |
| JSON | 189,452 | 16.7% |
| Go | 124,234 | 11.0% |
| HTML | 84,482 | 7.5% |
| Markdown | 75,403 | 6.7% |
...
------------------------------------------------------------
raizhost.com                   up         200    438ms       
app.raizhost.com               up         307    209ms       
jadenrazo.dev                  up         200    137ms       
llm.raizhost.com               up         200    414ms       
showersautodetail.com          up         200    115ms       
------------------------------------------------------------
fleet average                                    262ms       

Last check: 2026-08-26T11:58:10Z (3 probes per site, averaged)
```
<!-- DEPLOY_MONITOR_END -->
